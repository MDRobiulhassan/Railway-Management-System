...
<body class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="bg-white p-8 rounded shadow w-full max-w-md">
        <h2 class="text-2xl font-semibold text-center mb-6 text-slate-700">Recover Account</h2>
        @if ($errors->any())
        ...
        <p class="text-center text-sm text-gray-500 mt-4">
            <a href="{{ route('login.form') }}" class="text-green-700 font-semibold hover:underline">Back to Login</a>
        </p>
    </div>
</body>
</html>
